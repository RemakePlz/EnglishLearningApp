...
import com.zuel.englishlearning.object.JsonAccess;
...
public class BaiduHelper {
    ...
    public static final String API_KEY = "e4RIUkxtSWVihxB86vGPaKdM";

    public static final String SECRET_KEY = "GGlzTGKsj0kErjGv3tVWgWfmFlRGUMWc";
